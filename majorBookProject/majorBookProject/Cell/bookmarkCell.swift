...
//    //MARK: func
//    
//    func settingCell(isClicked: ExpandingTableViewCellContent ) {
//        
...
//    //MARK: setupLayouts
//    
//    private func setupLayouts(isClicked: ExpandingTableViewCellContent){
//        
...
//    private func setupConstraints(isClicked: ExpandingTableViewCellContent) {
//        
//        if isClicked.expanded{ //셀 확장시
